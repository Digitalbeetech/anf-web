...
};gdjs.ShopCode.asyncCallback13501572 = function (runtimeScene, asyncObjectsList) {
...
gdjs.ShopCode.idToCallbackMap.set(13501572, gdjs.ShopCode.asyncCallback13501572);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.ShopCode.asyncCallback13501572(runtimeScene, asyncObjectsList)), 13501572, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13506268);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("SubscribeButton"), gdjs.ShopCode.GDSubscribeButtonObjects1);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13508388);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("SubscribeButton"), gdjs.ShopCode.GDSubscribeButtonObjects1);
