...
gdjs.IntroCode.asyncCallback34513332 = function (runtimeScene, asyncObjectsList) {
...
gdjs.IntroCode.idToCallbackMap.set(34513332, gdjs.IntroCode.asyncCallback34513332);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.IntroCode.asyncCallback34513332(runtimeScene, asyncObjectsList)), 34513332, asyncObjectsList);
}
}
...
};gdjs.IntroCode.asyncCallback34514860 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.IntroCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "GameIntro", false);
}
gdjs.IntroCode.localVariables.length = 0;
}
gdjs.IntroCode.idToCallbackMap.set(34514860, gdjs.IntroCode.asyncCallback34514860);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.IntroCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.IntroCode.asyncCallback34514860(runtimeScene, asyncObjectsList)), 34514860, asyncObjectsList);
}
}
