...
gdjs.Lvl3_95FinishCode.idToCallbackMap = new Map();
...
};gdjs.Lvl3_95FinishCode.asyncCallback20933068 = function (runtimeScene, asyncObjectsList) {
...
gdjs.Lvl3_95FinishCode.idToCallbackMap.set(20933068, gdjs.Lvl3_95FinishCode.asyncCallback20933068);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Lvl3_95FinishCode.asyncCallback20933068(runtimeScene, asyncObjectsList)), 20933068, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20932604);
}
}
if (isConditionTrue_0) {
